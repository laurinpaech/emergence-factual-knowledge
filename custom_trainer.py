    ...
    def evaluation_loop(
        ...
        for step, inputs in enumerate(dataloader):
            ...
            if self.alias_lookup is not None:
                ...
                for i in range(step_rate):
                    ...
                    if test_alias is not None:
                        ...
                        if self.compute_metrics.__name__ in ['mean_reciprocal_rank_alias']:
                            logits_reduced_alias = torch.topk(logits_alias, k=1000, dim=-1)[1]
                        else:
            ...
            if logits is not None:
                ...
                if self.compute_metrics.__name__ in ['mean_reciprocal_rank', 'mean_reciprocal_rank_alias']:
        ...
        if self.compute_metrics is not None and all_preds is not None and all_labels is not None:
            ...
            elif self.compute_metrics.__name__ in ['precision_at_k_fixed_alias', 'mean_reciprocal_rank_alias']:
